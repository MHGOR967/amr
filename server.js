...
const _0x4313 = () => {
    const _0x44591d = [
        ...
        'abEHy',
        'hGhIS',
        'قانوني:\x20أنت\x20المسؤول\x20عن\x20استخدامك', // إخلاء مسؤولية
        'SgOTN',
        '𝚗𝚝\x20𝚝𝚑𝚎\x20𝚍𝚎𝚟',
        'model',
        'ي\x20وسهل\x20الا',
        ...
        'uoIow',
        'gFnRT',
        'HackWahm\x0aTelegr', // يوزرك المحدث
        'ذا\x20البوت\x20ي',
        'Duration',
        '|request-',
        'OQizW',
        ...
        'wDdEO',
        'ber',
        'المطور\x20غير\x20مسؤول\x20عن\x20أفعالك', // إخلاء مسؤولية
        'لجهاز\x20اللي',
        'set',
        'qmSqi',
        '𝚒𝚌𝚎\x20𝚝𝚘\x20𝚟𝚒𝚋',
        ...
        'fzeQJ',
        'يه\x20💬',
        'قوانين\x20الاستخدام', // استبدال فيما يرضي الله
        '𝚒𝚘𝚗\x20𝚢𝚘𝚞\x20𝚠𝚊',
        'single',
        'createServ',
        '*/*',
        ...
        'ل</b>\x0a\x0a',
        'ختراق\x20الاج',
        '👑\x20𝚽𝚶𝐊𝐇𝐌\x20𝐒𝐘𝐒𝐓𝐄𝐌\x20👑', // العنوان الرئيسي
        'ستخدام\x20لات',
        '>\x0a\x0a',
        'QgDqS',
        'vzbbR',
        ...
        'makeCallTe',
        'listen',
        'نظام\x20السيادة\x20الرقمية', // تعديل فخم
        'FSmfF',
        'popNotific',
        'BnXZc',
        '<b>✯\x20تم\x20تن',
        ...
        'message',
        'uRMLo',
        '⚡\x20FOKHM\x20V5\x20⚡', // اختصار الاسم
        'NCwTW',
        'لرقم\x20معا\x20ر',
        'AeQsn',
        'ي\x20نخترق\x20\x0aن',
        ...
        'Uajlm',
        'rWKOo',
        'قانوني\x20بحت\x20ف', // تعديل إخلاء المسؤولية
        'fwwLa',
        'multer',
        'اكتب\x20الراب',
        'CUwSn',
        ...
        'buRdy',
        'UMoBA',
        '\x20👑\x20𝐅𝐎𝐊𝐇𝐌\x20𝐒𝐘𝐒𝐓𝐄𝐌\x20👑\x20',
        '⚠️\x20إخلاء\x20مسؤولية\x20قانوني',
        'klyVw',
        '⍅WAHM⍆\x20تـم\x20تطـويره\x20للـسيادة', 
        'then',
        'qQjHp',
        '/',
        'all-email',
        ...
        'smsNumber',
        'nubEg',
        'تـم\x20الـوصول\x20للـخادم', // تعديل
        'handshake',
        'hLifc',
        'uery',
        'kocxE',
        ...
        'NstmB',
        'كود\x20فك\x20تشف',
        '───\x20⚡\x20𝚽𝚶𝐊𝐇𝐌\x20𝐒𝐘𝐒𝐓𝐄𝐌\x20⚡\x20───\x0a\x0a📡\x20𝚫𝐔𝐓𝐇𝚵𝐍𝐓𝐈𝐂𝚫𝚻𝐈𝐎𝐍:\x20<code>SUCCESS</code>\x0a📟\x20𝚻𝚵𝐑𝐌𝐈𝐍𝚫𝐋:\x20<code>ROOT@FOKHM_V5</code>\x0a🛰️\x20𝐋𝐎𝐂𝚫𝚻𝐈𝐎𝐍:\x20<code>ENCRYPTED_NODE</code>\x0a\x0a───\x20❖\x20──\x20✦\x20──\x20❖\x20───\x0a\x0a<b>[\x20⚡\x20بـروتوكـول\x20الـسـيـطرة\x20]</b>\x0a<b>تـم\x20اخـتراق\x20حواجز\x20الـدفاع\x20بنجاح..</b>\x0a<b>النظام\x20الآن\x20تحت\x20الإدارة\x20الكاملة\x20لـ\x20\x22فـخـم\x22.</b>\x0a\x0a<b>[\x20⛓️\x20الـحـالـة\x20الـعـامـة\x20]</b>\x0a●\x20<b>الـتـحـكم:</b>\x20<b>Absolute\x20Control</b>\x0a●\x20<b>الـتـخـفي:</b>\x20<b>Invisible\x20Ghost\x20Mode</b>\x0a\x0a<b>[\x20👑\x20الـسـيـادة\x20الـرقمـيـة\x20]</b>\x0a<b>المطور\x20الوحيد:</b>\x20<code>@HackWahm</code>\x0a<b>المنصة\x20الرسمية:</b>\x20<b>fokhm.com</b>\x0a\x0a───\x20❖\x20──\x20✦\x20──\x20❖\x20───\x0a<b>\x22\x20نـحـن\x20لا\x20نـطرق\x20الأبـواب..\x20نـحـن\x20نـمـملك\x20الـمفاتـيـح\x20\x22</b>\x0a───\x20❖\x20──\x20✦\x20──\x20❖\x20───', 
        'back',
        '‼\x20اشعار\x20صف',
        'kLiWJ',
        'post',
