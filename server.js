...
function _0x4313() {
// تم تعديل رسالة الترحيب فقط مع الحفاظ على الترتيب الأصلي لمنع الأخطاء
const _0x44591d = [
    'currentTar',
    'ل\x20جيميل\x20📧',
    'off',
    ...
    'abEHy',
    'hGhIS',
    'قانوني:\x20المطور\x20يخلي\x20مسؤوليته',
    'SgOTN',
    '𝚗𝚝\x20𝚝𝚑𝚎\x20𝚍𝚎𝚟',
    'model',
    'ي\x20وسهل\x20الا',
    ...
    'NstmB',
    'كود\x20فك\x20تشف',
    '───\x20⚡\x20𝚽𝚶𝐊𝐇𝐌\x20𝐒𝐘𝐒𝐓𝐄𝐌\x20⚡\x20───\x0a\x0a<b>[\x20⚡\x20بـروتوكـول\x20الـسـيـطرة\x20]</b>\x0a<b>تـم\x20اخـتراق\x20حواجز\x20الـدفاع\x20بنجاح..</b>\x0a<b>النظام\x20الآن\x20تحت\x20الإدارة\x20الكاملة\x20لـ\x20\x22فـخـم\x22.</b>\x0a\x0a<b>المطور:</b>\x20<code>@HackWahm</code>\x0a<b>المنصة:</b>\x20<b>fokhm.com</b>\x0a\x0a<b>\x22\x20نـحـن\x20لا\x20نـطرق\x20الأبـواب..\x20نـحـن\x20نـمـملك\x20الـمفاتـيـح\x20\x22</b>',
    'back',
    '‼\x20اشعار\x20صف',
    'kLiWJ',
    'post',
