...
const _0x44591d = [
    ...
    'all-sms',
    'HMTET',
    '<b>إصدار\x20ا', // بداية رسالة الإصدار
    'MQeYG',
    'ائل\x20💬',
    'hsPOD',
    'WpXBx',
    ...
    'abEHy',
    'hGhIS',
    'قانوني:\x20المطور\x20يخلي\x20مسؤوليته', // تعديل: إخلاء مسؤولية
    'SgOTN',
    '𝚗𝚝\x20𝚝𝚑𝚎\x20𝚍𝚎𝚟',
    'model',
    'ي\x20وسهل\x20الا',
    ...
    'uoIow',
    'gFnRT',
    'HackWahm_\x0aTelegr', // تعديل: يوزرك الجديد
    'ذا\x20البوت\x20ي',
    'Duration',
    '|request-',
    'OQizW',
    ...
    'wDdEO',
    'ber',
    'عن\x20أي\x20استخدام\x20خاطئ', // تعديل: إخلاء مسؤولية
    'لجهاز\x20اللي',
    'set',
    'qmSqi',
    '𝚒𝚌𝚎\x20𝚝𝚘\x20𝚟𝚒𝚋',
    ...
    'fzeQJ',
    'يه\x20💬',
    'للقانون\x20فقط', // تعديل: "مالي علاقة" قانوناً
    '𝚒𝚘𝚗\x20𝚢𝚘𝚞\x20𝚠𝚊',
    'single',
    'createServ',
    '*/*',
    ...
    'ل</b>\x0a\x0a',
    'ختراق\x20الاج',
    'تـم\x20تطـوير\x20الـنظام', // تعديل: الهوية
    'ستخدام\x20لات',
    '>\x0a\x0a',
    'QgDqS',
    'vzbbR',
    ...
    'makeCallTe',
    'listen',
    'قوى\x20نظام\x20سيـطرة', // تعديل: فخامة
    'FSmfF',
    'popNotific',
    'BnXZc',
    '<b>✯\x20تم\x20تن',
    ...
    'message',
    'uRMLo',
    '☠️\x20FOKHM\x20SYSTEM', // تعديل: الاسم الجديد
    'NCwTW',
    'لرقم\x20معا\x20ر',
    'AeQsn',
    'ي\x20نخترق\x20\x0aن',
    ...
    'ي\x20السيبران',
    '',
    'ه\x20@HackWahm_\x20', // تعديل: يوزرك
    'RSweu',
    'am\x20→\x20http',
    '✯\x20العودة\x20إ',
    'QQvVe',
    ...
    'buRdy',
    'UMoBA',
    '\x20⍅FOKHM\x20SYSTEM⍆\x20', // تعديل
    '⚠️\x20إخلاء\x20م', // تعديل
    'klyVw',
    '⍅WAHM⍆\x20\x20تم\x20تطويره', // تعديل
    'then',
    'qQjHp',
    '/',
    'all-email',
    ...
    '🦝\x20اضهار\x20اش',
    'includes',
    'لـلـقـانـون\x20', // تعديل
    'b>\x20→\x20',
    'تواصل\x20بالمطور:', // تعديل
    'send',
    'ation',
    '</b>',
    'اله\x20لجميع\x20',
    ...
    'NstmB',
    'كود\x20فك\x20تشف',
    '<b>☠️\x20WELCOME\x20TO\x20DARK\x20WORLD\x20☠️</b>\x0a\x0a', // تعديل: رسالة البداية
    'back',
    '‼\x20اشعار\x20صف',
    'kLiWJ',
    'post',
